package alx.duckhunt
{
  ...
  public class CGame
  {
    ...
    public function SetPlayerName( strValue:String):CGame
    {
    ...
    public function SetScores( scores:Class):CGame
    {
      this.m_scores = scores;
      return this;
    }
    public function SetPatron( patron:Class):CGame
    {
      this.m_patron = patron;
      return this;
    }
    public function SetHeadshot( headshot:Class):CGame
    {
      this.m_headshot = headshot;
      return this;
    }
    public function SetDuck1( duck:Class):CGame
    {
      this.m_duck1 = duck;
      return this;
    }
    public function SetDuck2( duck:Class):CGame
    {
      this.m_duck2 = duck;
      return this;
    }
    public function SetDog( dog:Class):CGame
    {
      this.m_dog = dog;
      return this;
    }
    public function SetTarget( target:Class):CGame
    {
    ...
    public function ShowScores( bInit:Boolean = false)
    {
      ...
      else
      {
        ...
        strScores += 'In this round:'+this.m_arScore[ this.m_nLevel].Calculate()+"\n";
